...
PRIMARY_ROOT = (
    REPO_ROOT / "save_model" / "grid_mamba" / "ablation_window_size_curve"
)
RERUN2_ROOT = (
    REPO_ROOT / "save_model" / "grid_mamba" / "ablation_window_size_curve_rerun2"
)
FULL_RUN_DIR = (
    REPO_ROOT
    / "save_model"
...
SELECTED_RUNS: Dict[int, Path] = {
    ...
    300: RERUN2_ROOT / "SC12_GS_G4_FINE_LOW_MID_W300_FULL",
    400: FULL_RUN_DIR,
...
def validate_registry() -> None:
    ...
    if SELECTED_RUNS[300].parent != RERUN2_ROOT:
        raise RuntimeError("The selected 300 ms run must come from rerun2")
