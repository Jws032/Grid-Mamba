...
DEFAULT_OUTPUT_ROOT = (
    base.REPO_ROOT / "save_model" / "grid_mamba" / "ablation_window_size_curve"
)
...
NO_TRUNC_WINDOW_MS = [50.0, 100.0, 200.0, 300.0, 400.0, 500.0, 600.0, 800.0, 1600.0]
