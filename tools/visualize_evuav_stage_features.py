...
DEFAULT_ROWS = (
    f"{REPO_ROOT / 'dataset/EV-UAV-dataset/test/test_020.npz'}:13:test_020 / w13",
    f"{REPO_ROOT / 'dataset/EV-UAV-dataset/test/test_019.npz'}:14:test_019 / w14",
)
DEFAULT_OUTPUT_DIR = (
    REPO_ROOT
    / "analysis_outputs/evuav_stage_features/test020_w13_test019_w14"
)
FEATURE_STAGES = (
    "embedding",
    "sparse_conv",
...
def main() -> int:
    ...
    if not model.use_spatial_window_context or not model.use_sparse_conv_encoder:
