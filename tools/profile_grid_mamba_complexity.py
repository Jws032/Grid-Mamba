...
DEFAULT_FULL_DIR = REPO_ROOT / "save_model" / "grid_mamba" / "ablation" / "C1"
DEFAULT_K1_DIR = REPO_ROOT / "save_model" / "grid_mamba" / "ablation" / "K1"
DEFAULT_OUTPUT = REPO_ROOT / "save_model" / "grid_mamba" / "complexity" / "full_vs_k1"
...
def profile_experiment(
    ...
    result = {
        ...
        "use_ts_embedding": bool(getattr(cfg, "use_ts_embedding", True)),
        "use_streaming_ts_embedding": bool(getattr(cfg, "use_streaming_ts_embedding", False)),
        "use_knn_spatial_encoder": bool(getattr(cfg, "use_knn_spatial_encoder", False)),
        "use_sparse_conv_encoder": bool(getattr(cfg, "use_sparse_conv_encoder", False)),
        "params": params,
