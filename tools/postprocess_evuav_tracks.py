...
DEFAULT_PREDICTIONS = (
    "save_model/grid_mamba/ablation_sparse_conv_fixed50/"
    "SC12_GS_G4_FINE_LOW_MID/test_best_iou/predictions.txt"
)
DEFAULT_DATASET_ROOT = "dataset/EV-UAV-dataset/test"
