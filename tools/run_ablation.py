...
EXPERIMENTS: Dict[str, Dict[str, Any]] = {
    # Group 1: main ablation.
    "A0": {
        "group": "main",
        "name": "no_ts_no_grid_pos_no_swc",
        "overrides": gm(
    ...
    "A3": {
        "group": "main",
        "name": "ts_grid_pos_swc_no_diffusion",
        "overrides": gm(
            use_ts_embedding=True,
            use_grid_pos_encoding=True,
            use_spatial_window_context=True,
    ...
    # Group 3: temporal cell diffusion source.
    "D0": {
        "group": "diffusion_source",
        "name": "prev_context",
        "overrides": gm(temporal_cell_diffusion_source="prev_context"),
    },
    "D1": {
        "group": "diffusion_source",
        "name": "prev_token",
        "overrides": gm(temporal_cell_diffusion_source="prev_token"),
    },
    "D2": {
        "group": "diffusion_source",
        "name": "dual",
        "overrides": gm(temporal_cell_diffusion_source="dual"),
    },
    # Group 4: multi-scale grid configuration.
    "G0": {
        "group": "grid_scale",
        "name": "small",
    ...
    # Group 6: spatial context stride.
    "C0": {
