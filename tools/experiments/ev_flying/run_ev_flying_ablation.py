...
This wrapper reuses tools.experiments.core.run_ablation for config generation, training,
...
EV_FLYING_EF54_25MS_SCALE_STRIDES = [
    [84.0, 70.0, 25.0],
    [168.0, 140.0, 25.0],
    [296.0, 236.0, 25.0],
]
...
EV_FLYING_EXPERIMENTS = {
    ...
    "EF54_25ms": {
        "group": "ev_flying_window_size_runtime",
        "name": "EF54_25ms",
        "overrides": base.merge_overrides(
            base.gm(
                window_size=25.0,
                scale_strides=EV_FLYING_EF54_25MS_SCALE_STRIDES,
            ...
            base.train(
                ...
                epochs=1,
                early_stopping=False,
                train_window_backward_chunk_size=8,
                train_window_checkpoint_chunk_size=8,
                empty_cache_every_batch=False,
            ),
            {
                "EXPERIMENT": {
                    "purpose": "runtime_only_checkpoint",
                    "performance_metrics_status": "diagnostic_only",
                    "source_experiment": "EF53_50ms",
                    "source_config_sha256": (
                        "17089e44cd76b6ad631c47bb4dff38e5"
                        "e70936b4ee67e3120a4e58ad96adb0f5"
                    ),
                    "training_budget_epochs": 1,
                    "checkpoint_selection": "only_completed_epoch_0",
                    "training_memory_strategy": (
                        "8_window_truncated_bptt_with_per_step_swc_checkpoint"
                    ),
                    "window_size_ms": 25.0,
                    "stream_duration_ms": 8000.0,
                    "expected_updates_per_stream": 320,
                    "output_frequency_hz": 40.0,
                }
            },
        ),
    },
